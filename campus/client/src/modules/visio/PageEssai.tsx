    ...
    <Page className="max-w-3xl">
      ...
      <section className="flex flex-col gap-3" aria-labelledby="essai-radio">
        ...
        <p className="text-base text-texte-pale">
          {t(
            "Quand ton forfait est petit, tu peux suivre le cours « à la radio » : le son du formateur seulement, environ 12 à 15 Mo par heure. Fais l'essai : parle, et tu t'entendras comme à la radio.",
            "Les étudiants au petit forfait suivent le cours « à la radio » : votre son seulement, environ 12 à 15 Mo par heure. Faites l'essai : parlez, vous vous entendrez comme eux vous entendront.",
          )}
        </p>
        <EssaiRadio tu={tu} />
      </section>
