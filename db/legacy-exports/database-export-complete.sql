...
-- Affichage des statistiques post-import
...
-- ==================================================================
-- FIN DE L'EXPORT
-- Export généré le 01 Septembre 2025 à 16:58
-- Total des enregistrements: ~35+ entrées
-- Tables principales: 12 tables avec données
-- ==================================================================