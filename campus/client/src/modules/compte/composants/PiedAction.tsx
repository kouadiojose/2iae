...
export function PiedAction({ children }: { children: ReactNode }) {
  return (
    <div className="fixed inset-x-0 bottom-0 z-20 border-t border-ligne-douce bg-white/95 px-4 pt-3 backdrop-blur-md sm:static sm:z-auto sm:border-0 sm:bg-transparent sm:px-0 sm:pt-8 sm:backdrop-blur-none">
