...
const values = [
  {
    ...
    title: "Excellence",
    description:
      "Nous visons l'excellence dans toutes nos formations et accompagnements pédagogiques.",
  },
  {
    icon: Eye,
    title: "Vision Entrepreneuriale",
    description:
      "Développer l'esprit entrepreneurial et l'innovation chez nos étudiants.",
  },
  {
    icon: Award,
    title: "Qualité",
...
const milestones = [
  {
    ...
    description:
      "Fondation de l'école avec une vision d'excellence entrepreneuriale",
  },
  {
    year: "2015",
    title: "Partenariat International",
    description:
      "Signature du partenariat avec l'Université de Sherbrooke, Canada",
  },
  {
    year: "2018",
    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 gradient-bg text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            L'École où l'apprentissage prend vie, formant l'élite
            ...
            <div>
              ...
              <div className="space-y-6 text-lg text-muted-foreground">
                <p data-testid="text-mission-paragraph-1">
                  ...
                  est né d'une vision claire : combler le vide dans la formation
                  entrepreneuriale en Côte d'Ivoire. Contrairement aux
                  formations traditionnelles axées sur les grandes entreprises,
                  nous nous concentrons sur la création d'entrepreneurs capables
                  de transformer l'économie africaine.
                </p>
                <p data-testid="text-mission-paragraph-2">
                  Notre approche pédagogique moderne combine théorie et
                  pratique, avec des outils digitaux de pointe et un
                  accompagnement personnalisé. Nous formons des leaders capables
                  de créer de la valeur et des emplois.
                </p>
                <p data-testid="text-mission-paragraph-3">
                  Avec notre partenariat international et nos programmes
                  homologués, nous offrons une formation d'excellence reconnue à
                  l'international tout en restant ancrés dans la réalité
      ...
      <section className="py-20 bg-muted">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            >
              Les principes qui guident notre approche pédagogique et notre
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            >
              Plus de 13 années d'innovation et d'excellence dans l'enseignement
              entrepreneurial
            </p>
          </div>
                    ...
                    <Card className="hover-lift professional-shadow">
                      <CardContent className="p-6">
                        <Badge
                          ...
                          data-testid={`badge-milestone-year-${index}`}
                        >
                          {milestone.year}
                        </Badge>
                        <h3
      ...
      <section className="py-20 bg-muted">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            Découvrez comment 2IAE International peut transformer votre avenir
            professionnel
          </p>
